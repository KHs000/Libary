	...
	<body>
		...
		<div class="centrolivro">
			<table class="tabelalivro">
				<tr>
					<td rowspan="4" colspan="2">imagem</td>
					<td colspan="5">Nome do Livro</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3">Ano de Publicação</td>
					<td colspan="3"> Editora </td>
				</tr>
				<tr>
					<td colspan="6">Campus e Localização completa</td>
				</tr>
				<tr>
					<td colspan="7">Realizar reservas caso disponível</td>
				</tr>
